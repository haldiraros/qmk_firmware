...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = EXPAND_LAYOUT( \
    ...
    _________________QWERTY_L5_________________,  RGB_TOG,  KC_MPLY,  _________________QWERTY_R5_________________, \
                                         KC_SPC,  KC_DEL,   KC_ENT,   KC_SPC \
  ),

#ifndef GAMELAYER_DISABLE
  [_GAME] = EXPAND_LAYOUT( \
    ___________________GAME_L1_________________,  KC_F1,    KC_F5,   ___________________GAME_R1_________________, \
    ___________________GAME_L2_________________,  KC_F2,    KC_F6,  ___________________GAME_R2_________________, \
    ___________________GAME_L3_________________,  KC_F3,    KC_F7,  ___________________GAME_R3_________________, \
    ___________________GAME_L4_________________,  KC_F4,    KC_F8,   ___________________GAME_R4_________________, \
    ___________________GAME_L5_________________,  RGB_TOG,  KC_MPLY,  ___________________GAME_R5_________________, \
                                         KC_SPC,  KC_DEL,   KC_ENT,   KC_SPC \
  ),
#endif
